...
// Deprecated: Extended thinking with a fixed budget is not supported on Opus
// 4.7+. Use WithEffort to control reasoning intensity instead. Retained for
// users on older CLI/model versions.
//
